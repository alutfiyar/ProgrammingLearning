...
<div style = "display:flex; flex-direction: column; justify-content:center; width: 800px; height: 100vh;  ">
<form style = "box-shadow:  0px 0px 2px 1px rgba(0, 0, 0, 0.2); padding: 40px 30px;" method = "POST" action = "{{Route('register')}}">
    @csrf
    <div>
        <h3>Registration</h3>
    </div>
